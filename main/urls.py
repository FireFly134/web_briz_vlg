...
urlpatterns = [
    ...
    # #########################################################################
    path("address_delete/<int:info_id>",
         views.address_delete,
         name="address_delete"),
    path("dispatcher_delete/<int:info_id>",
         views.dispatcher_delete,
         name="dispatcher_delete"),
    path("mechanics_delete/<int:info_id>",
         views.mechanics_delete,
         name="mechanics_delete"),
    path("routers_delete/<int:info_id>",
         views.routers_delete,
         name="routers_delete"),
    path("simcard_delete/<int:info_id>",
