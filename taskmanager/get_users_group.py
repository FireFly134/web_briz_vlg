...
def check_group(request: HttpRequest) -> dict[str, Any]:
    ...
    dict_nameURL_and_URL = {
        "Таблица роутеров": "router_list",
        "Карточки сотрудников": "employee_list",
        "Список контрагентов": "counterparty_list",
        "Реестр ремонта оборудования": "req_eq_list",
        # "":"",
    }
    ...
    engineer_dict_nameURL_and_URL = {
        ...
        "Добавление и изменение параметров обектной сборки": "object_assembly",
    }

    links.add_group_url(documents_dict_nameURL_and_URL, "Документы")
    links.add_url(dict_nameURL_and_URL)
